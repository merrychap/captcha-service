...
public class CaptchaProcessor implements RequestProcessorInterface {
    ...
    private HashMap<String, ResponseStructure> userId2Data;
    ...
    public ModelAndView processGetRequest(ModelMap model, HttpServletResponse response) throws IOException {
        ...
        userId2Data.put(userId, new ResponseStructure(captcha.generatedText, captcha.base64image, LocalDateTime.now()));
    ...
    public ModelAndView processPostRequest(ModelMap model, String[] params) {
        ...
        ResponseStructure expectedData = userId2Data.remove(userId);
    ...
    private ModelAndView processValidPost(ResponseStructure expectedData, ModelMap model) {
...
class ResponseStructure {
    ...
    public ResponseStructure(String captcha, String base64, LocalDateTime time) {
